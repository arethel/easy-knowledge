...
urlpatterns = [
    ...
    path('settings/change-settings', views.UserSettingsView.as_view({'post': 'change_settings'}), name='settings'),
    path('settings/get-settings', views.UserSettingsView.as_view({'get': 'get_settings'}), name='get-settings'),
]