...
from pdf_processing.pdf import extract_paragraphs_from_page, p_ended, unite_divided_paragraphs
import os
...
# print(unite_divided_paragraphs(['a.', 'b']))

for p in extract_paragraphs_from_page(books['en'][0], 101, 101)[0]:
    print(p)
    print('---')